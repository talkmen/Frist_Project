...
#include <string>
const std:: string CARDPATH = "card.dat";      // 卡信息记录文件
const std:: string BILLINGPATH = "billing.dat";   // 计费信息记录文件
const std:: string MONEYPATH = "money.dat";     // 充值退费记录文件 
...
const int UNIT = 15;           // 最小收费单元(分钟) const float CHARGE = 0.5f;       // 每个计费单元收费(元) 
